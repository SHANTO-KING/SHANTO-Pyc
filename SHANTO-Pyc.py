...
def baner():
	...
	sp("%s##     ## ######## ##     ## ##     ## #### ##    ##    "%(hijau))
	print ("%s+----------------------------------------------------------------+"%(putih))
	print ("%s[%s~%s] %sAuthor  %s: %sHRIDOY HOSSEN SHANTO"%(hijau,cyan,hijau,putih,merah,hijau))
	print ("%s[%s~%s] %sGithub  %s: %sSHANTO"%(hijau,cyan,hijau,putih,merah,hijau))
